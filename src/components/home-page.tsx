...
function HomePage() {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex justify-center">
        <p className="dark:text-[#F0E6D8] text-white absolute w-[280px] sm:ml-0 ml-3 md:w-[300px] lg:w-[340px] font-dmSerif font-[400] top-[80px] xl:top-[200px] lg:top-[150px] md:top-[120px] md:left-10 ipad-pro-landscape:top-[200px] xl:left-20 lg:left-14 ipad-pro-landscape:left-24 xl:text-[20px] lg:text-[18px] md:text-[14px] ipad-pro-landscape:text-[20px] text-[16px]">
